...
class Kafka(Storage):
    ...
    # Shell.tail
    def get_offsets(self, topic_str, n_int):
        partition_int_offset_int_dict = self.topics(topic_str, size=False, partitions=True)[topic_str]
        offsets_dict = {partition_int: offset_int - n_int for partition_int, offset_int in partition_int_offset_int_dict.items()}
        #
        return offsets_dict, "offsets"
